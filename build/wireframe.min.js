...
*/
!function(A){if("object"==typeof exports)module.exports=A();else if("function"==typeof define&&define.amd)define(A);else{var f;"undefined"!=typeof window?f=window:"undefined"!=typeof global?f=global:"undefined"!=typeof self&&(f=self);f.wireframe=A()}}(function(){return function f(q,r,d){function s(g,c){if(!r[g]){if(!q[g]){var m="function"==typeof require&&require;if(!c&&m)return m(g,!0);if(l)return l(g,!0);throw Error("Cannot find module '"+g+"'");}m=r[g]={exports:{}};q[g][0].call(m.exports,function(c){var a=
q[g][1][c];return s(a?a:c)},m,m.exports,f,q,r,d)}return r[g].exports}for(var l="function"==typeof require&&require,p=0;p<d.length;p++)s(d[p]);return s}({1:[function(f,q,r){(function(d){!function(f){if("object"==typeof r)q.exports=f();else{var l;"undefined"!=typeof window?l=window:"undefined"!=typeof d?l=d:"undefined"!=typeof self&&(l=self);l.Colour=f()}}(function(){return function l(d,g,c){function m(a,k){if(!g[a]){if(!d[a]){var b="function"==typeof f&&f;if(!k&&b)return b(a,!0);if(e)return e(a,!0);
throw Error("Cannot find module '"+a+"'");}b=g[a]={exports:{}};d[a][0].call(b.exports,function(b){var c=d[a][1][b];return m(c?c:b)},b,b.exports,l,d,g,c)}return g[a].exports}for(var e="function"==typeof f&&f,a=0;a<c.length;a++)m(c[a]);return m}({1:[function(d,f,g){function c(b,n){var c,t,d={};"string"===typeof b?(b=b.toLowerCase(),b in k?d=k[b]:(d=h(b),k[b]=d),t=d,c=a(d.r,d.g,d.b),n=d.a||n||1):"r"in b?(t=b,c=a(b.r,b.g,b.b),n=c.a||n||1):"h"in b&&(c=b,t=e(b.h,b.s,b.l),n=t.a||n||1);this.rgb={r:t.r,g:t.g,
b:t.b};this.hsl={h:c.h,s:c.s,l:c.l};this.alpha=n}function m(b,n,a){b<n?b=n:b>a&&(b=a);return b}var e,a,h,k;c.prototype.lighten=function(b){var n=this.hsl;b=n.l+b;100<b&&(b=100);return new c({h:n.h,s:n.s,l:b},this.alpha)};c.prototype.darken=function(b){var n=this.hsl;b=n.l-b;0>b&&(b=0);return new c({h:n.h,s:n.s,l:b},this.alpha)};c.prototype.toString=function(){var b=this.rgb.r.toString(16),n=this.rgb.g.toString(16),a=this.rgb.b.toString(16);1===b.length&&(b="0"+b);1===n.length&&(n="0"+n);1===a.length&&
(a="0"+a);return"#"+b+n+a};e=function(b,n,a){function c(b,n,a){0>a&&(a+=1);1<a&&(a-=1);return a<1/6?b+(n-b)*a*6:.5>a?n:a<2/3?b+(n-b)*(2/3-a)*6:b}var h=a/100,e=n/100;if(0===n)return b=255*h,{r:b,g:b,b:b};n=50>=a?h*(1+e):h+e-h*e;h=2*h-n;b/=360;return{r:Math.round(255*c(h,n,b+1/3)),g:Math.round(255*c(h,n,b)),b:Math.round(255*c(h,n,b-1/3))}};a=function(b,n,a){b/=255;n/=255;a/=255;var c=Math.max(b,n,a),h=Math.min(b,n,a),e=Math.round((h+c)/2*100);100<e&&(e=100);0>e&&(e=0);var k;if(h===c)return{h:0,s:0,
l:e};k=50>=e?(c-h)/(c+h):(c-h)/(2-c-h);var d=(c-b)/(c-h),g=(c-n)/(c-h);a=(c-a)/(c-h);b=(b===c?a-g:n===c?2+d-a:4+g-d)/6%1;0>b&&(b+=1);b=Math.round(360*b);k=Math.round(100*k);360<b&&(b=360);0>b&&(b=0);100<k&&(k=100);0>k&&(k=0);return{h:b,s:k,l:e}};h=function(b){var n,a,c,h=1,k,d=!1;k=b.substr(0,3);if("hsl"===k)(k=/hsla?\(\s*(-?\d+)\s*,\s*(-?\d+)%\s*,\s*(-?\d+)%\s*(,\s*(-?\d+(\.\d+)?)\s*)?\)/g.exec(b))?(n=parseInt(k[1],10),a=parseInt(k[2],10),c=parseInt(k[3],10),"a"===b[3]&&(h=parseFloat(k[5])),n=Math.abs(n%
360),a=m(a,0,100),c=m(c,0,100),k=e(n,a,c),n=k.r,a=k.g,c=k.b):d=!0;else if("rgb"===k)if(k=/rgba?\((-?\d+%?)\s*,\s*(-?\d+%?)\s*,\s*(-?\d+%?)(,\s*(-?\d+(\.\d+)?)\s*)?\)/g.exec(b)){var g=k[1],f=k[2],l=k[3];n=parseInt(k[1],10);a=parseInt(k[2],10);c=parseInt(k[3],10);if("%"===g[g.length-1]||"%"===f[f.length-1]||"%"===l[l.length-1])"%"===g[g.length-1]&&"%"===f[f.length-1]&&"%"===l[l.length-1]?(n=Math.floor(n/100*255),a=Math.floor(a/100*255),c=Math.floor(c/100*255)):d=!0;n=m(n,0,255);a=m(a,0,255);c=m(c,0,
255);"a"===b[3]&&(h=parseFloat(k[5]))}else d=!0;else"#"===b[0]?(k=b.substr(1),3===k.length?(n=parseInt(k[0]+k[0],16),a=parseInt(k[1]+k[1],16),c=parseInt(k[2]+k[2],16)):6===k.length?(n=parseInt(k[0]+k[1],16),a=parseInt(k[2]+k[3],16),c=parseInt(k[4]+k[5],16)):d=!0):d=!0;h=m(h,0,1);if(d)throw"ColourError: Something went wrong. Perhaps "+b+" is not a legal CSS color value";return{r:n,g:a,b:c,a:h}};k={black:{r:0,g:0,b:0,h:0,s:0,l:0},silver:{r:192,g:192,b:192,h:0,s:0,l:75},gray:{r:128,g:128,b:128,h:0,s:0,
...
q,r){(function(d){!function(f){if("object"==typeof r)q.exports=f();else{var l;"undefined"!=typeof window?l=window:"undefined"!=typeof d?l=d:"undefined"!=typeof self&&(l=self);l.linearalgea=f()}}(function(){return function l(d,g,c){function m(a,k){if(!g[a]){if(!d[a]){var b="function"==typeof f&&f;if(!k&&b)return b(a,!0);if(e)return e(a,!0);throw Error("Cannot find module '"+a+"'");}b=g[a]={exports:{}};d[a][0].call(b.exports,function(b){var c=d[a][1][b];return m(c?c:b)},b,b.exports,l,d,g,c)}return g[a].exports}
for(var e="function"==typeof f&&f,a=0;a<c.length;a++)m(c[a]);return m}({1:[function(d,f,g){g=d("./vector.js");d=d("./matrix.js");var c=Object.create(null);c.Vector=g;c.Matrix=d;f.exports=c},{"./matrix.js":2,"./vector.js":3}],2:[function(d,f,g){function c(){for(var b=0;16>b;b++)this[b]=0;this.length=16}d=d("./vector.js");c.prototype.equal=function(b){for(var n=0,a=this.length;n<a;n++)if(this[n]!==b[n])return!1;return!0};c.prototype.add=function(b){for(var n=new c,a=0,h=this.length;a<h;a++)n[a]=this[a]+
b[a];return n};c.prototype.addLG=function(b,a){a[0]=this[0]+b[0];a[1]=this[1]+b[1];a[2]=this[2]+b[2];a[3]=this[3]+b[3];a[4]=this[4]+b[4];a[5]=this[5]+b[5];a[6]=this[6]+b[6];a[7]=this[7]+b[7];a[8]=this[8]+b[8];a[9]=this[9]+b[9];a[10]=this[10]+b[10];a[11]=this[11]+b[11];a[12]=this[12]+b[12];a[13]=this[13]+b[13];a[14]=this[14]+b[14];a[15]=this[15]+b[15];return a};c.prototype.subtract=function(b){for(var a=new c,h=0,e=this.length;h<e;h++)a[h]=this[h]-b[h];return a};c.prototype.subtractLG=function(b,a){a[0]=
this[0]-b[0];a[1]=this[1]-b[1];a[2]=this[2]-b[2];a[3]=this[3]-b[3];a[4]=this[4]-b[4];a[5]=this[5]-b[5];a[6]=this[6]-b[6];a[7]=this[7]-b[7];a[8]=this[8]-b[8];a[9]=this[9]-b[9];a[10]=this[10]-b[10];a[11]=this[11]-b[11];a[12]=this[12]-b[12];a[13]=this[13]-b[13];a[14]=this[14]-b[14];a[15]=this[15]-b[15];return a};c.prototype.multiplyScalar=function(b){for(var a=new c,h=0,e=this.length;h<e;h++)a[h]=this[h]*b;return a};c.prototype.multiplyScalarLG=function(b,a){a[0]=this[0]*b;a[1]=this[1]*b;a[2]=this[2]*
...
d;l.target=this;var p=this._listeners[d];if("undefined"!==typeof p)for(var g=0,c=p.length;g<c;g++)p[g].call(this,l)},removeListener:function(d,f){for(var l=this._listeners[d],p=0,g=l.length;p<g;p++)l[p]===f&&l.splice(p,1)}}},{}],6:[function(f,q,r){function d(e){this.width=e.width;this.height=e.height;this.canvas=document.getElementById(e.canvas_id);this.ctx=this.canvas.getContext("2d");this.ctx.strokeStyle="red";this.camera=new s(this.width,this.height);this.illumination=new c(90,0,0);this.meshes=
...
this._back_buffer_image.data;var b=4*c;a[b]=f.r;a[b+1]=f.g;a[b+2]=f.b;a[b+3]=255;this._depth_buffer[c]=d}};d.prototype.drawEdge=function(c,a,d){var f=Math.abs;if(c.x>=a.x){var b=c;c=a;a=b}var b=c.x,n=c.y,g=c.z,f=Math.max(f(a.x-c.x),f(a.y-c.y),f(a.z-c.z)),m=(a.x-c.x)/f,l=(a.y-c.y)/f;c=(a.z-c.z)/f;for(a=0;a<f;a++)this.drawPixel(Math.floor(b),Math.floor(n),g,d),b+=m,n+=l,g+=c};d.prototype.quickLine=function(c,a){this.ctx.moveTo(c.x+this._x_offset,c.y+this._y_offset);this.ctx.lineTo(a.x+this._x_offset,
a.y+this._y_offset)};d.prototype.drawTriangle=function(c,a,d,f){this._quickdraw?(this.quickLine(c,a),this.quickLine(a,d),this.quickLine(d,c)):(this.drawEdge(c,a,f),this.drawEdge(a,d,f),this.drawEdge(d,c,f))};d.prototype.fillTriangle=function(c,a,d,f){var b=c.x,g=a.x,m=d.x,l=c.y,p=a.y,q=d.y;c=c.z;a=a.z;d=d.z;var r=0-this._x_offset,s=this.width-this._x_offset,y=0-this._y_offset,u=this.height-this._y_offset,v=Math.floor(Math.min(b,g,m));v<r&&(v=r);r=Math.ceil(Math.max(b,g,m));r>s&&(r=s);s=Math.floor(Math.min(l,
p,q));s<y&&(s=y);y=Math.ceil(Math.max(l,p,q));y>u&&(y=u);for(var B=q-l,z=b-m,w=l-p,u=g-b,x=m*l-b*q,b=b*p-g*l,g=B*g+z*p+x,l=w*m+u*q+b,m=B/g,q=z/g,g=x/g,p=w/l,u=u/l,b=b/l;v<=r;v++)for(l=s;l<=y;l++)w=m*v+q*l+g,0<=w&&1>=w&&(x=p*v+u*l+b,0<=x&&1>=x&&(z=1-w-x,0<=z&&1>=z&&this.drawPixel(v,l,z*c+w*a+x*d,f)))};d.prototype.renderScene=function(){this._quickdraw?(this.ctx.clearRect(0,0,this.canvas.width,this.canvas.height),this.ctx.beginPath()):(this._clear_back_buffer_image(),this.initializeDepthBuffer());var c=
this.camera.view_matrix,a=this.camera.perspectiveFov,d=this.illumination,f;for(f in this.meshes)if(this.meshes.hasOwnProperty(f)){var b=this.meshes[f],g=b.scale,l=b.rotation,p=b.position;m.scaleLG(g.x,g.y,g.z,this._scale_matrix);m.rotationLG(l.pitch,l.yaw,l.roll,this._rotation_matrix);m.translationLG(p.x,p.y,p.z,this._translation_matrix);this._scale_matrix.multiplyLG(this._rotation_matrix,this._world_matrix);this._world_matrix.multiplyLG(this._translation_matrix,this._world_matrix);for(g=0;g<b.faces.length;g++){var q=
b.faces[g].face,l=b.faces[g].color,p=b.vertices[q[0]],r=b.vertices[q[1]],q=b.vertices[q[2]];p.transformLG(this._world_matrix,this._v1t);r.transformLG(this._world_matrix,this._v2t);q.transformLG(this._world_matrix,this._v3t);this.camera.position.subtractLG(this._v1t,this._cam_to_vert);this._v2t.subtractLG(this._v1t,this._side1);this._v3t.subtractLG(this._v1t,this._side2);this._side1.crossLG(this._side2,this._norm);1E-8<=this._norm.magnitude()&&this._norm.normalizeLG(this._norm);if(!this._backface_culling||
0<=this._cam_to_vert.dot(this._norm))this._world_matrix.multiplyLG(c,this._temp_matrix),this._temp_matrix.multiplyLG(a,this._wvp_matrix),p.transformLG(this._wvp_matrix,this._wv1),r.transformLG(this._wvp_matrix,this._wv2),q.transformLG(this._wvp_matrix,this._wv3),p=!0,this.offscreen(this._wv1)&&this.offscreen(this._wv2)&&this.offscreen(this._wv3)&&(p=!1),p&&(0===this._draw_mode?this.drawTriangle(this._wv1,this._wv2,this._wv3,l.rgb):1===this._draw_mode&&(d.subtractLG(this._v1t,this._light_direction),
this._light_direction.normalizeLG(this._light_direction),p=this._norm.dot(this._light_direction),l=l.lighten(15*p),this.fillTriangle(this._wv1,this._wv2,this._wv3,l.rgb)))}}this._quickdraw?(this.ctx.stroke(),this.ctx.closePath()):(this._back_buffer_ctx.putImageData(this._back_buffer_image,0,0),this.ctx.clearRect(0,0,this.canvas.width,this.canvas.height),this.ctx.drawImage(this._back_buffer,0,0,this.canvas.width,this.canvas.height))};d.prototype.addMesh=function(c){this.meshes[c.name]=c};d.prototype.removeMesh=
...
8:[function(f,q,r){var d=f("colour");q.exports=function(f,l,p,g){this.face=[f,l,p];this.color=new d(g)}},{colour:1}],9:[function(f,q,r){r=f("./mesh.js");f=f("./face.js");q.exports.Mesh=r;q.exports.Face=f},{"./face.js":8,"./mesh.js":10}],10:[function(f,q,r){function d(d,f,c){this.name=d;this.vertices=f;this.faces=c;this.position=new s(0,0,0);this.rotation={yaw:0,pitch:0,roll:0};this.scale={x:1,y:1,z:1}}var s=f("linearalgea").Vector,l=f("./face.js");d.fromJSON=function(f){for(var g=[],c=[],m=0,e=f.vertices.length;m<
e;m++){var a=f.vertices[m];g.push(new s(a[0],a[1],a[2]))}m=0;for(e=f.faces.length;m<e;m++)a=f.faces[m],c.push(new l(a.face[0],a.face[1],a.face[2],a.color));return new d(f.name,g,c)};q.exports=d},{"./face.js":8,linearalgea:2}],11:[function(f,q,r){q.exports={space:32,backspace:8,tab:9,enter:13,shift:16,ctrl:17,alt:18,pause_break:19,caps_lock:20,escape:27,page_up:33,"page down":34,end:35,home:36,left_arrow:37,up_arrow:38,right_arrow:39,down_arrow:40,insert:45,"delete":46,0:48,1:49,2:50,3:51,4:52,5:53,
...
num_lock:144,scroll_lock:145,semi_colon:186,equal_sign:187,comma:188,dash:189,period:190,forward_slash:191,grave_accent:192,open_bracket:219,backslash:220,closebracket:221,single_quote:222}},{}],12:[function(f,q,r){q.exports=function(d,f){for(var l in f)f.hasOwnProperty(l)&&(d[l]=f[l]);return d}},{}]},{},[7])(7)});
