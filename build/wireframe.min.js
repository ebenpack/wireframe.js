...
m,a),e=Math.round((h+c)/2*100);100<e&&(e=100);0>e&&(e=0);var k;if(h===c)return{h:0,s:0,l:e};k=50>=e?(c-h)/(c+h):(c-h)/(2-c-h);var d=(c-b)/(c-h),g=(c-m)/(c-h);a=(c-a)/(c-h);b=(b===c?a-g:m===c?2+d-a:4+g-d)/6%1;0>b&&(b+=1);b=Math.round(360*b);k=Math.round(100*k);360<b&&(b=360);0>b&&(b=0);100<k&&(k=100);0>k&&(k=0);return{h:b,s:k,l:e}};h=function(b){var m,a,c,h=1,k,d=!1;k=b.substr(0,3);if("hsl"===k)(k=/hsla?\(\s*(-?\d+)\s*,\s*(-?\d+)%\s*,\s*(-?\d+)%\s*(,\s*(-?\d+(\.\d+)?)\s*)?\)/g.exec(b))?(m=parseInt(k[1],
10),a=parseInt(k[2],10),c=parseInt(k[3],10),"a"===b[3]&&(h=parseFloat(k[5])),m=Math.abs(m%360),a=l(a,0,100),c=l(c,0,100),k=e(m,a,c),m=k.r,a=k.g,c=k.b):d=!0;else if("rgb"===k)if(k=/rgba?\((-?\d+%?)\s*,\s*(-?\d+%?)\s*,\s*(-?\d+%?)(,\s*(-?\d+(\.\d+)?)\s*)?\)/g.exec(b)){var g=k[1],f=k[2],n=k[3];m=parseInt(k[1],10);a=parseInt(k[2],10);c=parseInt(k[3],10);if("%"===g[g.length-1]||"%"===f[f.length-1]||"%"===n[n.length-1])"%"===g[g.length-1]&&"%"===f[f.length-1]&&"%"===n[n.length-1]?(m=Math.floor(m/100*255),
a=Math.floor(a/100*255),c=Math.floor(c/100*255)):d=!0;m=l(m,0,255);a=l(a,0,255);c=l(c,0,255);"a"===b[3]&&(h=parseFloat(k[5]))}else d=!0;else"#"===b[0]?(k=b.substr(1),3===k.length?(m=parseInt(k[0]+k[0],16),a=parseInt(k[1]+k[1],16),c=parseInt(k[2]+k[2],16)):6===k.length?(m=parseInt(k[0]+k[1],16),a=parseInt(k[2]+k[3],16),c=parseInt(k[4]+k[5],16)):d=!0):d=!0;h=l(h,0,1);if(d)throw"ColourError: Something went wrong. Perhaps "+b+" is not a legal CSS color value";return{r:m,g:a,b:c,a:h}};k={black:{r:0,g:0,
...
{},[1])(1)})}).call(this,"undefined"!==typeof self?self:"undefined"!==typeof window?window:{})},{}],2:[function(f,p,r){(function(d){!function(f){if("object"==typeof r)p.exports=f();else{var n;"undefined"!=typeof window?n=window:"undefined"!=typeof d?n=d:"undefined"!=typeof self&&(n=self);n.linearalgea=f()}}(function(){return function n(d,g,c){function l(a,k){if(!g[a]){if(!d[a]){var b="function"==typeof f&&f;if(!k&&b)return b(a,!0);if(e)return e(a,!0);throw Error("Cannot find module '"+a+"'");}b=g[a]=
{exports:{}};d[a][0].call(b.exports,function(b){var c=d[a][1][b];return l(c?c:b)},b,b.exports,n,d,g,c)}return g[a].exports}for(var e="function"==typeof f&&f,a=0;a<c.length;a++)l(c[a]);return l}({1:[function(d,f,g){g=d("./vector.js");d=d("./matrix.js");var c=Object.create(null);c.Vector=g;c.Matrix=d;f.exports=c},{"./matrix.js":2,"./vector.js":3}],2:[function(d,f,g){function c(){for(var b=0;16>b;b++)this[b]=0;this.length=16}d=d("./vector.js");c.prototype.equal=function(b){for(var m=0,a=this.length;m<
...
function(b){var a=new c,h=Math.cos(b);b=Math.sin(b);a[0]=h;a[1]=-b;a[4]=b;a[5]=h;a[10]=1;a[15]=1;return a};c.rotationZLG=function(b,a){var c=Math.cos(b),h=Math.sin(b);a[0]=c;a[1]=-h;a[2]=0;a[3]=0;a[4]=h;a[5]=c;a[6]=0;a[7]=0;a[8]=0;a[9]=0;a[10]=1;a[11]=0;a[12]=0;a[13]=0;a[14]=0;a[15]=1;return a};c.rotationAxis=function(b,a){var h=new c,e=b.normalize(),k=Math.sin(a),d=Math.cos(a),g=1-d,l=e.x,f=e.y,e=e.z,n=l*f,q=l*e,p=f*e;h[0]=d+l*l*g;h[1]=n*g-e*k;h[2]=q*g+f*k;h[4]=n*g+e*k;h[5]=d+f*f*g;h[6]=p*g-l*k;
h[8]=q*g-f*k;h[9]=p*g+l*k;h[10]=d+e*e*g;h[15]=1;return h};c.rotationAxisLG=function(b,a,c){b.normalizeLG(k);b=Math.sin(a);a=Math.cos(a);var h=1-a,e=k.x,d=k.y,g=k.z,l=e*d,f=e*g,n=d*g;c[0]=a+e*e*h;c[1]=l*h-g*b;c[2]=f*h+d*b;c[3]=0;c[4]=l*h+g*b;c[5]=a+d*d*h;c[6]=n*h-e*b;c[7]=0;c[8]=f*h-d*b;c[9]=n*h+e*b;c[10]=a+g*g*h;c[11]=0;c[12]=0;c[13]=0;c[14]=0;c[15]=1;return c};c.rotation=function(a,h,e){return c.rotationX(e).multiply(c.rotationZ(h)).multiply(c.rotationY(a))};c.rotationLG=function(b,m,k,d){c.rotationXLG(k,
l);c.rotationZLG(m,e);c.rotationYLG(b,a);l.multiplyLG(e,h);h.multiplyLG(a,d);return d};c.translation=function(a,h,e){var k=c.identity();k[12]=a;k[13]=h;k[14]=e;return k};c.translationLG=function(a,c,h,e){e[0]=1;e[1]=0;e[2]=0;e[3]=0;e[4]=0;e[5]=1;e[6]=0;e[7]=0;e[8]=0;e[9]=0;e[10]=1;e[12]=a;e[13]=c;e[14]=h;e[15]=1;return e};c.scale=function(a,h,e){var k=new c;k[0]=a;k[5]=h;k[10]=e;k[15]=1;return k};c.scaleLG=function(a,c,h,e){e[0]=a;e[1]=0;e[2]=0;e[3]=0;e[4]=0;e[5]=c;e[6]=0;e[7]=0;e[8]=0;e[9]=0;e[10]=
...
this._temp_vector1.scaleLG(d,this._temp_vector2);this.position.subtractLG(this._temp_vector2,this.position);this.createViewMatrix()};p.exports=d},{linearalgea:2}],4:[function(f,p,r){r=f("./scene.js");f=f("./camera.js");p.exports.Scene=r;p.exports.Camera=f},{"./camera.js":3,"./scene.js":6}],5:[function(f,p,r){p.exports={_listeners:{},addListener:function(d,f){d in this._listeners||(this._listeners[d]=[]);this._listeners[d].push(f)},fire:function(d,f){var n={};"undefined"!==typeof f&&(n=f);n.event=
d;n.target=this;var q=this._listeners[d];if("undefined"!==typeof q)for(var g=0,c=q.length;g<c;g++)q[g].call(this,n)},removeListener:function(d,f){for(var n=this._listeners[d],q=0,g=n.length;q<g;q++)n[q]===f&&n.splice(q,1)}}},{}],6:[function(f,p,r){function d(e){this.width=e.width;this.height=e.height;this.canvas=document.getElementById(e.canvas_id);this.ctx=this.canvas.getContext("2d");this.ctx.strokeStyle="red";this.camera=new s(this.width,this.height);this.illumination=new c(90,0,0);this.meshes=
...
this._back_buffer_image.data;var b=4*c;a[b]=f.rgb.r;a[b+1]=f.rgb.g;a[b+2]=f.rgb.b;a[b+3]=255;this._depth_buffer[c]=d}};d.prototype.drawEdge=function(c,a,d){var f=Math.abs;if(c.x>=a.x){var b=c;c=a;a=b}var b=c.x,m=c.y,g=c.z,f=Math.max(f(a.x-c.x),f(a.y-c.y),f(a.z-c.z)),l=(a.x-c.x)/f,n=(a.y-c.y)/f;c=(a.z-c.z)/f;for(a=0;a<f;a++)this.drawPixel(Math.floor(b),Math.floor(m),g,d),b+=l,m+=n,g+=c};d.prototype.quickLine=function(c,a){var d=Math.round(c.x+this._x_offset),f=Math.round(c.y+this._y_offset),b=Math.round(a.x+
this._x_offset),m=Math.round(a.y+this._y_offset);this.ctx.moveTo(d,f);this.ctx.lineTo(b,m)};d.prototype.drawTriangle=function(c,a,d,f){this._quickdraw?(this.quickLine(c,a),this.quickLine(a,d),this.quickLine(d,c)):(this.drawEdge(c,a,f),this.drawEdge(a,d,f),this.drawEdge(d,c,f))};d.prototype.fillTriangle=function(c,a,d,f){var b=c.x,m=a.x,g=d.x,l=c.y,n=a.y,q=d.y;c=c.z;a=a.z;d=d.z;var p=0-this._x_offset,r=this.width-this._x_offset,s=0-this._y_offset,u=this.height-this._y_offset,v=Math.floor(Math.min(b,
m,g));v<p&&(v=p);p=Math.ceil(Math.max(b,m,g));p>r&&(p=r);r=Math.floor(Math.min(l,n,q));r<s&&(r=s);s=Math.ceil(Math.max(l,n,q));s>u&&(s=u);for(var A=q-l,y=b-g,w=l-n,u=m-b,x=g*l-b*q,b=b*n-m*l,m=A*m+y*n+x,l=w*g+u*q+b,g=A/m,q=y/m,m=x/m,n=w/l,u=u/l,b=b/l;v<=p;v++)for(l=r;l<=s;l++)w=g*v+q*l+m,0<=w&&1>=w&&(x=n*v+u*l+b,0<=x&&1>=x&&(y=1-w-x,0<=y&&1>=y&&this.drawPixel(v,l,y*c+w*a+x*d,f)))};d.prototype.renderScene=function(){this._quickdraw&&0===this._draw_mode?(this.ctx.clearRect(0,0,this.canvas.width,this.canvas.height),
this.ctx.beginPath()):(this._clear_back_buffer_image(),this.initializeDepthBuffer());var c=this.camera.view_matrix,a=this.camera.perspectiveFov,d=this.illumination,f;for(f in this.meshes)if(this.meshes.hasOwnProperty(f)){var b=0,g=this.meshes[f],n=g.scale,q=g.rotation,p=g.position;l.scaleLG(n.x,n.y,n.z,this._scale_matrix);l.rotationLG(q.pitch,q.yaw,q.roll,this._rotation_matrix);l.translationLG(p.x,p.y,p.z,this._translation_matrix);this._scale_matrix.multiplyLG(this._rotation_matrix,this._world_matrix);
this._world_matrix.multiplyLG(this._translation_matrix,this._world_matrix);for(n=0;n<g.faces.length;n++){var r=g.faces[n].face,q=g.faces[n].color,p=g.vertices[r[0]],s=g.vertices[r[1]],r=g.vertices[r[2]];p.transformLG(this._world_matrix,this._v1t);s.transformLG(this._world_matrix,this._v2t);r.transformLG(this._world_matrix,this._v3t);this.camera.position.subtractLG(this._v1t,this._cam_to_vert);this._v2t.subtractLG(this._v1t,this._side1);this._v3t.subtractLG(this._v1t,this._side2);this._side1.crossLG(this._side2,
this._norm);1E-8<=this._norm.magnitude()&&this._norm.normalizeLG(this._norm);if(!this._backface_culling||0<=this._cam_to_vert.dot(this._norm))this._world_matrix.multiplyLG(c,this._temp_matrix),this._temp_matrix.multiplyLG(a,this._wvp_matrix),p.transformLG(this._wvp_matrix,this._wv1),s.transformLG(this._wvp_matrix,this._wv2),r.transformLG(this._wvp_matrix,this._wv3),p=!0,this.offscreen(this._wv1)&&this.offscreen(this._wv2)&&this.offscreen(this._wv3)&&(p=!1),p&&(0===this._draw_mode?(this.drawTriangle(this._wv1,
this._wv2,this._wv3,q),b+=1,this._quickdraw&&0===b%200&&(this.ctx.stroke(),this.ctx.closePath(),this.ctx.beginPath())):1===this._draw_mode&&(d.subtractLG(this._v1t,this._light_direction),this._light_direction.normalizeLG(this._light_direction),p=this._norm.dot(this._light_direction),q=q.lighten(15*p),this.fillTriangle(this._wv1,this._wv2,this._wv3,q.rgb)))}}this._quickdraw&&0===this._draw_mode?(this.ctx.stroke(),this.ctx.closePath()):(this._back_buffer_ctx.putImageData(this._back_buffer_image,0,0),
this.ctx.clearRect(0,0,this.canvas.width,this.canvas.height),this.ctx.drawImage(this._back_buffer,0,0,this.canvas.width,this.canvas.height))};d.prototype.addMesh=function(c){this.meshes[c.name]=c};d.prototype.removeMesh=function(c){delete this.meshes[c.name]};d.prototype.update=function(){0<this._key_count&&this.fire("keydown");this._needs_update&&(this.renderScene(),this._needs_update=!1);this._anim_id=window.requestAnimationFrame(this.update.bind(this))};p.exports=d},{"../utilities/keycodes.js":11,
"../utilities/mixin.js":12,"./camera.js":3,"./events.js":5,linearalgea:2}],7:[function(f,p,r){r=f("./geometry/geometry.js");f=f("./engine/engine.js");p.exports.geometry=r;p.exports.engine=f},{"./engine/engine.js":4,"./geometry/geometry.js":9}],8:[function(f,p,r){var d=f("colour");p.exports=function(f,n,q,g){this.face=[f,n,q];this.color=new d(g)}},{colour:1}],9:[function(f,p,r){r=f("./mesh.js");f=f("./face.js");p.exports.Mesh=r;p.exports.Face=f},{"./face.js":8,"./mesh.js":10}],10:[function(f,p,r){function d(d,
f,c){this.name=d;this.vertices=f;this.faces=c;this.position=new s(0,0,0);this.rotation={yaw:0,pitch:0,roll:0};this.scale={x:1,y:1,z:1}}var s=f("linearalgea").Vector,n=f("./face.js");d.fromJSON=function(f){for(var g=[],c=[],l=0,e=f.vertices.length;l<e;l++){var a=f.vertices[l];g.push(new s(a[0],a[1],a[2]))}l=0;for(e=f.faces.length;l<e;l++)a=f.faces[l],c.push(new n(a.face[0],a.face[1],a.face[2],a.color));return new d(f.name,g,c)};p.exports=d},{"./face.js":8,linearalgea:2}],11:[function(f,p,r){p.exports=
