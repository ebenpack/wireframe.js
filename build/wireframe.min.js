...
*/
!function(A){if("object"==typeof exports)module.exports=A();else if("function"==typeof define&&define.amd)define(A);else{var f;"undefined"!=typeof window?f=window:"undefined"!=typeof global?f=global:"undefined"!=typeof self&&(f=self);f.wireframe=A()}}(function(){return function f(q,r,d){function s(h,c){if(!r[h]){if(!q[h]){var m="function"==typeof require&&require;if(!c&&m)return m(h,!0);if(l)return l(h,!0);throw Error("Cannot find module '"+h+"'");}m=r[h]={exports:{}};q[h][0].call(m.exports,function(c){var a=
q[h][1][c];return s(a?a:c)},m,m.exports,f,q,r,d)}return r[h].exports}for(var l="function"==typeof require&&require,n=0;n<d.length;n++)s(d[n]);return s}({1:[function(f,q,r){(function(d){!function(f){if("object"==typeof r)q.exports=f();else{var l;"undefined"!=typeof window?l=window:"undefined"!=typeof d?l=d:"undefined"!=typeof self&&(l=self);l.Colour=f()}}(function(){return function l(d,h,c){function m(a,k){if(!h[a]){if(!d[a]){var b="function"==typeof f&&f;if(!k&&b)return b(a,!0);if(e)return e(a,!0);
throw Error("Cannot find module '"+a+"'");}b=h[a]={exports:{}};d[a][0].call(b.exports,function(b){var c=d[a][1][b];return m(c?c:b)},b,b.exports,l,d,h,c)}return h[a].exports}for(var e="function"==typeof f&&f,a=0;a<c.length;a++)m(c[a]);return m}({1:[function(d,f,h){function c(b,p){var c,t,d={};"string"===typeof b?(b=b.toLowerCase(),b in k?d=k[b]:(d=g(b),k[b]=d),t=d,c=a(d.r,d.g,d.b),p=d.a||p||1):"r"in b?(t=b,c=a(b.r,b.g,b.b),p=c.a||p||1):"h"in b&&(c=b,t=e(b.h,b.s,b.l),p=t.a||p||1);this.rgb={r:t.r,g:t.g,
b:t.b};this.hsl={h:c.h,s:c.s,l:c.l};this.alpha=p;this._color_string=this._toString()}function m(b,p,a){b<p?b=p:b>a&&(b=a);return b}var e,a,g,k;c.prototype.lighten=function(b){var p=this.hsl;b=p.l+b;100<b&&(b=100);return new c({h:p.h,s:p.s,l:b},this.alpha)};c.prototype.darken=function(b){var p=this.hsl;b=p.l-b;0>b&&(b=0);return new c({h:p.h,s:p.s,l:b},this.alpha)};c.prototype.toString=function(){return this._color_string};c.prototype._toString=function(){var b=this.rgb.r.toString(16),p=this.rgb.g.toString(16),
a=this.rgb.b.toString(16);1===b.length&&(b="0"+b);1===p.length&&(p="0"+p);1===a.length&&(a="0"+a);return"#"+b+p+a};e=function(b,p,a){function c(b,p,a){0>a&&(a+=1);1<a&&(a-=1);return a<1/6?b+(p-b)*a*6:.5>a?p:a<2/3?b+(p-b)*(2/3-a)*6:b}var g=a/100,e=p/100;if(0===p)return b=255*g,{r:b,g:b,b:b};p=50>=a?g*(1+e):g+e-g*e;g=2*g-p;b/=360;return{r:Math.round(255*c(g,p,b+1/3)),g:Math.round(255*c(g,p,b)),b:Math.round(255*c(g,p,b-1/3))}};a=function(b,p,a){b/=255;p/=255;a/=255;var c=Math.max(b,p,a),g=Math.min(b,
p,a),e=Math.round((g+c)/2*100);100<e&&(e=100);0>e&&(e=0);var k;if(g===c)return{h:0,s:0,l:e};k=50>=e?(c-g)/(c+g):(c-g)/(2-c-g);var d=(c-b)/(c-g),h=(c-p)/(c-g);a=(c-a)/(c-g);b=(b===c?a-h:p===c?2+d-a:4+h-d)/6%1;0>b&&(b+=1);b=Math.round(360*b);k=Math.round(100*k);360<b&&(b=360);0>b&&(b=0);100<k&&(k=100);0>k&&(k=0);return{h:b,s:k,l:e}};g=function(b){var p,a,c,g=1,k,d=!1;k=b.substr(0,3);if("hsl"===k)(k=/hsla?\(\s*(-?\d+)\s*,\s*(-?\d+)%\s*,\s*(-?\d+)%\s*(,\s*(-?\d+(\.\d+)?)\s*)?\)/g.exec(b))?(p=parseInt(k[1],
10),a=parseInt(k[2],10),c=parseInt(k[3],10),"a"===b[3]&&(g=parseFloat(k[5])),p=Math.abs(p%360),a=m(a,0,100),c=m(c,0,100),k=e(p,a,c),p=k.r,a=k.g,c=k.b):d=!0;else if("rgb"===k)if(k=/rgba?\((-?\d+%?)\s*,\s*(-?\d+%?)\s*,\s*(-?\d+%?)(,\s*(-?\d+(\.\d+)?)\s*)?\)/g.exec(b)){var h=k[1],f=k[2],l=k[3];p=parseInt(k[1],10);a=parseInt(k[2],10);c=parseInt(k[3],10);if("%"===h[h.length-1]||"%"===f[f.length-1]||"%"===l[l.length-1])"%"===h[h.length-1]&&"%"===f[f.length-1]&&"%"===l[l.length-1]?(p=Math.floor(p/100*255),
a=Math.floor(a/100*255),c=Math.floor(c/100*255)):d=!0;p=m(p,0,255);a=m(a,0,255);c=m(c,0,255);"a"===b[3]&&(g=parseFloat(k[5]))}else d=!0;else"#"===b[0]?(k=b.substr(1),3===k.length?(p=parseInt(k[0]+k[0],16),a=parseInt(k[1]+k[1],16),c=parseInt(k[2]+k[2],16)):6===k.length?(p=parseInt(k[0]+k[1],16),a=parseInt(k[2]+k[3],16),c=parseInt(k[4]+k[5],16)):d=!0):d=!0;g=m(g,0,1);if(d)throw"ColourError: Something went wrong. Perhaps "+b+" is not a legal CSS color value";return{r:p,g:a,b:c,a:g}};k={black:{r:0,g:0,
...
this[0]*b[2]+this[1]*b[6]+this[2]*b[10]+this[3]*b[14];a[3]=this[0]*b[3]+this[1]*b[7]+this[2]*b[11]+this[3]*b[15];a[4]=this[4]*b[0]+this[5]*b[4]+this[6]*b[8]+this[7]*b[12];a[5]=this[4]*b[1]+this[5]*b[5]+this[6]*b[9]+this[7]*b[13];a[6]=this[4]*b[2]+this[5]*b[6]+this[6]*b[10]+this[7]*b[14];a[7]=this[4]*b[3]+this[5]*b[7]+this[6]*b[11]+this[7]*b[15];a[8]=this[8]*b[0]+this[9]*b[4]+this[10]*b[8]+this[11]*b[12];a[9]=this[8]*b[1]+this[9]*b[5]+this[10]*b[9]+this[11]*b[13];a[10]=this[8]*b[2]+this[9]*b[6]+this[10]*
b[10]+this[11]*b[14];a[11]=this[8]*b[3]+this[9]*b[7]+this[10]*b[11]+this[11]*b[15];a[12]=this[12]*b[0]+this[13]*b[4]+this[14]*b[8]+this[15]*b[12];a[13]=this[12]*b[1]+this[13]*b[5]+this[14]*b[9]+this[15]*b[13];a[14]=this[12]*b[2]+this[13]*b[6]+this[14]*b[10]+this[15]*b[14];a[15]=this[12]*b[3]+this[13]*b[7]+this[14]*b[11]+this[15]*b[15];return a};c.prototype.negate=function(){for(var b=new c,a=0,g=this.length;a<g;a++)b[a]=-this[a];return b};c.prototype.negateLG=function(b){b[0]=-this[0];b[1]=-this[1];
...
function(b){b[0]=this[0];b[1]=this[4];b[2]=this[8];b[3]=this[12];b[4]=this[1];b[5]=this[5];b[6]=this[9];b[7]=this[13];b[8]=this[2];b[9]=this[6];b[10]=this[10];b[11]=this[14];b[12]=this[3];b[13]=this[7];b[14]=this[11];b[15]=this[15];return b};c.prototype.empty=function(){for(var b=0,a=this.length;b<a;b++)this[b]=0};c.prototype.copy=function(b){for(var a=0;16>a;a++)b[a]=this[a];return b};c.rotationX=function(b){var a=new c,g=Math.cos(b);b=Math.sin(b);a[0]=1;a[5]=g;a[6]=-b;a[9]=b;a[10]=g;a[15]=1;return a};
c.rotationXLG=function(b,a){var c=Math.cos(b),g=Math.sin(b);a[0]=1;a[1]=0;a[2]=0;a[3]=0;a[4]=0;a[5]=c;a[6]=-g;a[7]=0;a[8]=0;a[9]=g;a[10]=c;a[11]=0;a[12]=0;a[13]=0;a[14]=0;a[15]=1;return a};c.rotationY=function(b){var a=new c,g=Math.cos(b);b=Math.sin(b);a[0]=g;a[2]=b;a[5]=1;a[8]=-b;a[10]=g;a[15]=1;return a};c.rotationYLG=function(b,a){var c=Math.cos(b),g=Math.sin(b);a[0]=c;a[1]=0;a[2]=g;a[3]=0;a[4]=0;a[5]=1;a[6]=0;a[7]=0;a[8]=-g;a[9]=0;a[10]=c;a[11]=0;a[12]=0;a[13]=0;a[14]=0;a[15]=1;return a};c.rotationZ=
function(b){var a=new c,g=Math.cos(b);b=Math.sin(b);a[0]=g;a[1]=-b;a[4]=b;a[5]=g;a[10]=1;a[15]=1;return a};c.rotationZLG=function(b,a){var c=Math.cos(b),g=Math.sin(b);a[0]=c;a[1]=-g;a[2]=0;a[3]=0;a[4]=g;a[5]=c;a[6]=0;a[7]=0;a[8]=0;a[9]=0;a[10]=1;a[11]=0;a[12]=0;a[13]=0;a[14]=0;a[15]=1;return a};c.rotationAxis=function(b,a){var g=new c,e=b.normalize(),k=Math.sin(a),d=Math.cos(a),h=1-d,m=e.x,f=e.y,e=e.z,l=m*f,n=m*e,q=f*e;g[0]=d+m*m*h;g[1]=l*h-e*k;g[2]=n*h+f*k;g[4]=l*h+e*k;g[5]=d+f*f*h;g[6]=q*h-m*k;
g[8]=n*h-f*k;g[9]=q*h+m*k;g[10]=d+e*e*h;g[15]=1;return g};c.rotationAxisLG=function(b,a,c){b.normalizeLG(k);b=Math.sin(a);a=Math.cos(a);var g=1-a,e=k.x,d=k.y,h=k.z,m=e*d,f=e*h,l=d*h;c[0]=a+e*e*g;c[1]=m*g-h*b;c[2]=f*g+d*b;c[3]=0;c[4]=m*g+h*b;c[5]=a+d*d*g;c[6]=l*g-e*b;c[7]=0;c[8]=f*g-d*b;c[9]=l*g+e*b;c[10]=a+h*h*g;c[11]=0;c[12]=0;c[13]=0;c[14]=0;c[15]=1;return c};c.rotation=function(b,a,g){return c.rotationX(g).multiply(c.rotationZ(a)).multiply(c.rotationY(b))};c.rotationLG=function(b,k,d,h){c.rotationXLG(d,
m);c.rotationZLG(k,e);c.rotationYLG(b,a);m.multiplyLG(e,g);g.multiplyLG(a,h);return h};c.translation=function(b,a,g){var e=c.identity();e[12]=b;e[13]=a;e[14]=g;return e};c.translationLG=function(b,a,c,g){g[0]=1;g[1]=0;g[2]=0;g[3]=0;g[4]=0;g[5]=1;g[6]=0;g[7]=0;g[8]=0;g[9]=0;g[10]=1;g[12]=b;g[13]=a;g[14]=c;g[15]=1;return g};c.scale=function(a,g,e){var k=new c;k[0]=a;k[5]=g;k[10]=e;k[15]=1;return k};c.scaleLG=function(a,c,g,e){e[0]=a;e[1]=0;e[2]=0;e[3]=0;e[4]=0;e[5]=c;e[6]=0;e[7]=0;e[8]=0;e[9]=0;e[10]=
g;e[11]=0;e[12]=0;e[13]=0;e[14]=0;e[15]=1;return e};c.identity=function(){var a=new c;a[0]=1;a[5]=1;a[10]=1;a[15]=1;return a};c.identityLG=function(a){a[0]=1;a[1]=0;a[2]=0;a[3]=0;a[4]=0;a[5]=1;a[6]=0;a[7]=0;a[8]=0;a[9]=0;a[10]=1;a[11]=0;a[12]=0;a[13]=0;a[14]=0;a[15]=1;return a};c.zero=function(){return new c};c.zeroLG=function(a){a[0]=0;a[1]=0;a[2]=0;a[3]=0;a[4]=0;a[5]=0;a[6]=0;a[7]=0;a[8]=0;a[9]=0;a[10]=0;a[11]=0;a[12]=0;a[13]=0;a[14]=0;a[15]=0;return a};c.fromArray=function(a){for(var g=new c,e=
0;16>e;e++)g[e]=a[e];return g};c.fromArrayLG=function(a,c){c[0]=a[0];c[1]=a[1];c[2]=a[2];c[3]=a[3];c[4]=a[4];c[5]=a[5];c[6]=a[6];c[7]=a[7];c[8]=a[8];c[9]=a[9];c[10]=a[10];c[11]=a[11];c[12]=a[12];c[13]=a[13];c[14]=a[14];c[15]=a[15];return c};c.copy=function(a,c){for(var g=0;16>g;g++)c[g]=a[g];return c};var m=new c,e=new c,a=new c,g=new c,k=new d(0,0,0);f.exports=c},{"./vector.js":3}],3:[function(d,f,h){function c(a,c,e){if("undefined"===typeof a||"undefined"===typeof c||"undefined"===typeof e)throw Error("Insufficient arguments.");
...
a*c;this._zaxis.x=f*e;this._zaxis.y=-c;this._zaxis.z=e*a;l.fromArrayLG([this._xaxis.x,this._yaxis.x,this._zaxis.x,0,this._xaxis.y,this._yaxis.y,this._zaxis.y,0,this._xaxis.z,this._yaxis.z,this._zaxis.z,0,-this._xaxis.dot(d),-this._yaxis.dot(d),-this._zaxis.dot(d),1],this.view_matrix)};d.prototype.look=function(d,c){this.rotation.yaw-=d;0>this.rotation.yaw?this.rotation.yaw+=n:this.rotation.yaw>n&&(this.rotation.yaw-=n);this.rotation.pitch-=c;0>this.rotation.pitch?this.rotation.pitch+=n:this.rotation.pitch>
n&&(this.rotation.pitch-=n);this.createViewMatrix()};d.prototype.turnRight=function(d){this.rotation.yaw-=d;0>this.rotation.yaw&&(this.rotation.yaw+=n);this.createViewMatrix()};d.prototype.turnLeft=function(d){this.rotation.yaw+=d;this.rotation.yaw>n&&(this.rotation.yaw-=n);this.createViewMatrix()};d.prototype.lookUp=function(d){this.rotation.pitch-=d;this.rotation.pitch>n&&(this.rotation.pitch-=n);this.createViewMatrix()};d.prototype.lookDown=function(d){this.rotation.pitch+=d;0>this.rotation.pitch&&
(this.rotation.pitch+=n);this.createViewMatrix()};d.prototype.moveTo=function(d,c,f){this.position.x=d;this.position.y=c;this.position.z=f;this.createViewMatrix()};d.prototype.move=function(d,c,f){this.position.x+=d;this.position.y+=c;this.position.z+=f;this.createViewMatrix()};d.prototype.moveRight=function(d){this.direction();this._direction.normalizeLG(this._temp_vector1);this._temp_vector1.scaleLG(d,this._temp_vector2);this.up.crossLG(this._temp_vector2,this._temp_vector1);this.position.subtractLG(this._temp_vector1,
...
0,0);this._wv1=new c(0,0,0);this._wv2=new c(0,0,0);this._wv3=new c(0,0,0);this._v1=new c(0,0,0);this._v2=new c(0,0,0);this._v3=new c(0,0,0);this._v1t=new c(0,0,0);this._v2t=new c(0,0,0);this._v3t=new c(0,0,0);this._wvp_matrix=new m;this._world_matrix=new m;this._rotation_matrix=new m;this._translation_matrix=new m;this._scale_matrix=new m;this._cam_to_vert=new c(0,0,0);this._temp_matrix=new m;this._side1=new c(0,0,0);this._side2=new c(0,0,0);this._norm=new c(0,0,0)}r=f("linearalgea");var s=f("./camera.js"),
l=f("./events.js"),n=f("../utilities/mixin.js"),h=f("../utilities/keycodes.js"),c=r.Vector,m=r.Matrix;n(d.prototype,l);d.prototype.emptyKeys=function(){this._key_count=0;this._keys={}};d.prototype.isKeyDown=function(c){c=h[c];return c in this._keys&&this._keys[c]};d.prototype.onKeyDown=function(c){c=c.keyCode||c.which;this.isKeyDown(c)||(this._key_count+=1,this._keys[c]=!0)};d.prototype.onKeyUp=function(c){c=c.keyCode||c.which;c in this._keys&&(this._key_count-=1,this._keys[c]=!1)};d.prototype._getMousePos=
...
this._back_buffer_image.data;var b=4*c;a[b]=f.rgb.r;a[b+1]=f.rgb.g;a[b+2]=f.rgb.b;a[b+3]=255;this._depth_buffer[c]=d}};d.prototype.drawEdge=function(c,a,d){var f=Math.abs;if(c.x>=a.x){var b=c;c=a;a=b}var b=c.x,h=c.y,m=c.z,f=Math.max(f(a.x-c.x),f(a.y-c.y),f(a.z-c.z)),l=(a.x-c.x)/f,n=(a.y-c.y)/f;c=(a.z-c.z)/f;for(a=0;a<f;a++)this.drawPixel(Math.floor(b),Math.floor(h),m,d),b+=l,h+=n,m+=c};d.prototype.quickLine=function(c,a,d){var f=Math.round(c.x+this._x_offset);c=Math.round(c.y+this._y_offset);var b=
Math.round(a.x+this._x_offset);a=Math.round(a.y+this._y_offset);this.ctx.beginPath();this.ctx.strokeStyle=d.toString();this.ctx.moveTo(f,c);this.ctx.lineTo(b,a);this.ctx.stroke();this.ctx.closePath()};d.prototype.drawTriangle=function(c,a,d,f){this._quickdraw?(this.quickLine(c,a,f),this.quickLine(a,d,f),this.quickLine(d,c,f)):(this.drawEdge(c,a,f),this.drawEdge(a,d,f),this.drawEdge(d,c,f))};d.prototype.fillTriangle=function(c,a,d,f){var b=c.x,h=a.x,m=d.x,l=c.y,n=a.y,q=d.y;c=c.z;a=a.z;d=d.z;var r=
0-this._x_offset,s=this.width-this._x_offset,y=0-this._y_offset,u=this.height-this._y_offset,v=Math.floor(Math.min(b,h,m));v<r&&(v=r);r=Math.ceil(Math.max(b,h,m));r>s&&(r=s);s=Math.floor(Math.min(l,n,q));s<y&&(s=y);y=Math.ceil(Math.max(l,n,q));y>u&&(y=u);for(var B=q-l,z=b-m,w=l-n,u=h-b,x=m*l-b*q,b=b*n-h*l,h=B*h+z*n+x,l=w*m+u*q+b,m=B/h,q=z/h,h=x/h,n=w/l,u=u/l,b=b/l;v<=r;v++)for(l=s;l<=y;l++)w=m*v+q*l+h,0<=w&&1>=w&&(x=n*v+u*l+b,0<=x&&1>=x&&(z=1-w-x,0<=z&&1>=z&&this.drawPixel(v,l,z*c+w*a+x*d,f)))};d.prototype.renderScene=
function(){this._quickdraw&&0===this._draw_mode?(this.ctx.clearRect(0,0,this.canvas.width,this.canvas.height),this.ctx.beginPath()):(this._clear_back_buffer_image(),this.initializeDepthBuffer());var c=this.camera.view_matrix,a=this.camera.perspectiveFov,d=this.illumination,f;for(f in this.meshes)if(this.meshes.hasOwnProperty(f)){var b=this.meshes[f],h=b.scale,l=b.rotation,n=b.position;m.scaleLG(h.x,h.y,h.z,this._scale_matrix);m.rotationLG(l.pitch,l.yaw,l.roll,this._rotation_matrix);m.translationLG(n.x,
n.y,n.z,this._translation_matrix);this._scale_matrix.multiplyLG(this._rotation_matrix,this._world_matrix);this._world_matrix.multiplyLG(this._translation_matrix,this._world_matrix);for(h=0;h<b.faces.length;h++){var q=b.faces[h].face,l=b.faces[h].color,n=b.vertices[q[0]],r=b.vertices[q[1]],q=b.vertices[q[2]];n.transformLG(this._world_matrix,this._v1t);r.transformLG(this._world_matrix,this._v2t);q.transformLG(this._world_matrix,this._v3t);this.camera.position.subtractLG(this._v1t,this._cam_to_vert);
this._v2t.subtractLG(this._v1t,this._side1);this._v3t.subtractLG(this._v1t,this._side2);this._side1.crossLG(this._side2,this._norm);1E-8<=this._norm.magnitude()&&this._norm.normalizeLG(this._norm);if(!this._backface_culling||0<=this._cam_to_vert.dot(this._norm))this._world_matrix.multiplyLG(c,this._temp_matrix),this._temp_matrix.multiplyLG(a,this._wvp_matrix),n.transformLG(this._wvp_matrix,this._wv1),r.transformLG(this._wvp_matrix,this._wv2),q.transformLG(this._wvp_matrix,this._wv3),n=!0,this.offscreen(this._wv1)&&
this.offscreen(this._wv2)&&this.offscreen(this._wv3)&&(n=!1),n&&(0===this._draw_mode?this.drawTriangle(this._wv1,this._wv2,this._wv3,l):1===this._draw_mode&&(d.subtractLG(this._v1t,this._light_direction),this._light_direction.normalizeLG(this._light_direction),n=this._norm.dot(this._light_direction),l=l.lighten(15*n),this.fillTriangle(this._wv1,this._wv2,this._wv3,l.rgb)))}}this._quickdraw&&0===this._draw_mode?(this.ctx.stroke(),this.ctx.closePath()):(this._back_buffer_ctx.putImageData(this._back_buffer_image,
0,0),this.ctx.clearRect(0,0,this.canvas.width,this.canvas.height),this.ctx.drawImage(this._back_buffer,0,0,this.canvas.width,this.canvas.height))};d.prototype.addMesh=function(c){this.meshes[c.name]=c};d.prototype.removeMesh=function(c){delete this.meshes[c.name]};d.prototype.update=function(){0<this._key_count&&this.fire("keydown");this._needs_update&&(this.renderScene(),this._needs_update=!1);this._anim_id=window.requestAnimationFrame(this.update.bind(this))};q.exports=d},{"../utilities/keycodes.js":11,
"../utilities/mixin.js":12,"./camera.js":3,"./events.js":5,linearalgea:2}],7:[function(f,q,r){r=f("./geometry/geometry.js");f=f("./engine/engine.js");q.exports.geometry=r;q.exports.engine=f},{"./engine/engine.js":4,"./geometry/geometry.js":9}],8:[function(f,q,r){var d=f("colour");q.exports=function(f,l,n,h){this.face=[f,l,n];this.color=new d(h)}},{colour:1}],9:[function(f,q,r){r=f("./mesh.js");f=f("./face.js");q.exports.Mesh=r;q.exports.Face=f},{"./face.js":8,"./mesh.js":10}],10:[function(f,q,r){function d(d,
f,c){this.name=d;this.vertices=f;this.faces=c;this.position=new s(0,0,0);this.rotation={yaw:0,pitch:0,roll:0};this.scale={x:1,y:1,z:1}}var s=f("linearalgea").Vector,l=f("./face.js");d.fromJSON=function(f){for(var h=[],c=[],m=0,e=f.vertices.length;m<e;m++){var a=f.vertices[m];h.push(new s(a[0],a[1],a[2]))}m=0;for(e=f.faces.length;m<e;m++)a=f.faces[m],c.push(new l(a.face[0],a.face[1],a.face[2],a.color));return new d(f.name,h,c)};q.exports=d},{"./face.js":8,linearalgea:2}],11:[function(f,q,r){q.exports=
{space:32,backspace:8,tab:9,enter:13,shift:16,ctrl:17,alt:18,pause_break:19,caps_lock:20,escape:27,page_up:33,"page down":34,end:35,home:36,left_arrow:37,up_arrow:38,right_arrow:39,down_arrow:40,insert:45,"delete":46,0:48,1:49,2:50,3:51,4:52,5:53,6:54,7:55,8:56,9:57,a:65,b:66,c:67,d:68,e:69,f:70,g:71,h:72,i:73,j:74,k:75,l:76,m:77,n:78,o:79,p:80,q:81,r:82,s:83,t:84,u:85,v:86,w:87,x:88,y:89,z:90,"left_window key":91,"right_window key":92,select_key:93,"numpad 0":96,"numpad 1":97,"numpad 2":98,"numpad 3":99,
"numpad 4":100,"numpad 5":101,"numpad 6":102,"numpad 7":103,"numpad 8":104,"numpad 9":105,multiply:106,add:107,subtract:109,"decimal point":110,divide:111,f1:112,f2:113,f3:114,f4:115,f5:116,f6:117,f7:118,f8:119,f9:120,f10:121,f11:122,f12:123,num_lock:144,scroll_lock:145,semi_colon:186,equal_sign:187,comma:188,dash:189,period:190,forward_slash:191,grave_accent:192,open_bracket:219,backslash:220,closebracket:221,single_quote:222}},{}],12:[function(f,q,r){q.exports=function(d,f){for(var l in f)f.hasOwnProperty(l)&&
(d[l]=f[l]);return d}},{}]},{},[7])(7)});
